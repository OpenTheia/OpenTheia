...
public class MenuAndFingerTracking {
    ...
    private menuAndFingerInfo grabLockedMenuAndFingerInfoFromImage(Mat inputImage) {
        ...
        camParams.loadConstandCalibration(inputImage.cols()/2,inputImage.rows()/2);
        ...
        mDetector.detect(inputImage, detectedMarkers, camParams, MARKER_SIZE);
        ...
        if (detectedMarkers.size() != 0) {
            ...
            Imgproc.cvtColor(inputImage, highlightedImage, Imgproc.COLOR_RGBA2RGB);
        ...
        Imgproc.warpPerspective(inputImage, resultImage, savedWarpMatrix, new Size(savedResultMenuWidth,savedResultMenuHeight));
